...
def extract_features(audio_file_path, target_length):
    try:
        ...
        # Resize log mel spectrogram to the input size of MobileNetV2
...
for i, (train_folders, test_folders) in enumerate(folder_combinations, 1):
    ...
    # Preprocess input data to have 3 channels (as required by MobileNetV2)
    ...
    # Flatten features to be compatible with the fully connected layers of MobileNetV2
